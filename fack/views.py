...
class TopicDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        data['topics'] = Topic.objects.exclude(slug=self.object.slug)

        return data


rst_settings = {'initial_header_level': 2}
QUESTIONS = {}
...
class QuestionDetail(DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if not self.object.pk in QUESTIONS:
            QUESTIONS[self.object.pk] = {
                'excerpt': publish_parts(
                    self.object.excerpt,
                    writer_name='html5',
                    settings_overrides=rst_settings
                )['body'],
                'answer': publish_parts(
                    self.object.answer,
                    writer_name='html5',
                    settings_overrides=rst_settings
                )['body'],
        ...
        data.update(QUESTIONS[self.object.pk])
